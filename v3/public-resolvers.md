...
DNSCrypt Resolver | IPv4 only | Non-logging | Non-filtering | DNSSEC | Hanoi, Vietnam.
The first Public DNSCrypt Resolver in Vietnam.
Operated by VHP (Git @vophuc8712). Powered by iNET-Vietnam.
[Currently running a 7-day test of real user traffic to the server]
